...
public class OnlineBookstore extends JFrame {
 ...
 // Declaration and show component on GUI
    ...
    private void initComponents() {
        ...
        quantityL.setBounds(30, 260, 90, 16);
        ...
        quantityTF.setBounds(100, 260, 130, 22);
        ...
        weightL.setBounds(290, 210, 110, 16);
        weightTF.setEditable(false);
        getContentPane().add(weightTF);
        weightTF.setBounds(380, 210, 140, 22);
        ...
        searchB.setBounds(230, 310, 140, 23);
        ...
        convertB.setBounds(210, 400, 200, 23);
        ...
        shippingcostB.setBounds(210, 370, 200, 23);
    ...
    private void searchBActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (booktype == "physical book") {
            PhysicalBook physicalBook1 = physicalBookinfo();
            message = "Title: " + physicalBook1.getTitle() + "\n";
            message += "Book Type: " + booktype + "\n";
            message += "Author: " + physicalBook1.getAuthor() + "\n";
            message += "Price: " + physicalBook1.getPrice() + "\n";
            message += "Quantity: " + physicalBook1.getQuantity() + "\n";
            message += "Weight: " + physicalBook1.getWeight() + "\n";
        } else if (booktype == "ebook") {
            EBook eBook1 = EBookinfo();
            message = "Title: " + eBook1.getTitle() + "\n";
            message += "Book Type: " + booktype + "\n";
            message += "Author: " + eBook1.getAuthor() + "\n";
            message += "Price (RM): " + eBook1.getPrice() + "\n";
            message += "Quantity: " + eBook1.getQuantity() + "\n";
            message += "File Format: " + eBook1.getFileFormat() + "\n";
        }
        JOptionPane.showMessageDialog(null, message, "Action",
                JOptionPane.INFORMATION_MESSAGE);
    }
